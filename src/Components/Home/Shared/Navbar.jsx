            ...
            <div className="navbar bg-amber-300 font-serif font-bold px-4">
                ...
                <div className="navbar-center  lg:flex">
                    <ul className="menu menu-horizontal px-1 ">
                        ...
                        {user && <Link to='/AllJewellers'><li><a>All jewelry</a></li></Link>}
                        {user && <Link to='/myJewellers'> <li><a>My jewelry</a></li></Link>}
                        {user && <Link to='/AddJeweller'><li><a>Add jewelry</a></li></Link>}
